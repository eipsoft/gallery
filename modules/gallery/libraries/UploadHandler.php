...
namespace app\modules\gallery\libraries;
/*
...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/images/upload/',
            'upload_url' => $this->get_full_url().'/images/upload/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    public static function get_full_url_static() {
        $https = !empty($_SERVER['HTTPS']) && strcasecmp($_SERVER['HTTPS'], 'on') === 0 ||
                    !empty($_SERVER['HTTP_X_FORWARDED_PROTO']) &&
                        strcasecmp($_SERVER['HTTP_X_FORWARDED_PROTO'], 'https') === 0;
        return
    ...
    protected function gd_create_scaled_image($file_name, $version, $options) {
        ...
        if (is_numeric(($w = 20000)) &&
            $max_width > $w) {
            $max_width = $w;
        }
        if (is_numeric(($h = 20000)) &&
            $max_height > $h) {
            $max_height = $h;
        }
